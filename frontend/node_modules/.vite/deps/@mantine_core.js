...
import {
  ...
  size,
  useFloating
} from "./chunk-OIAXGD2D.js";
import {
  Combination_default
} from "./chunk-PQOG4ITZ.js";
import {
  require_react_dom
...
function useRandomClassName() {
  const id = (0, import_react106.useId)().replace(/:/g, "");
  return `__m__-${id}`;
}
...
// node_modules/@mantine/core/esm/core/Box/Box.mjs
var _Box = (0, import_react107.forwardRef)(
  ({
    component,
    style,
    __vars,
...
function getWithProps(Component) {
  ...
  return (fixedProps) => {
    const Extended = (0, import_react108.forwardRef)((props, ref) => (0, import_jsx_runtime34.jsx)(_Component, { ...fixedProps, ...props, ref }));
...
function polymorphicFactory(ui) {
  ...
  Component.withProps = (fixedProps) => {
    const Extended = (0, import_react109.forwardRef)((props, ref) => (0, import_jsx_runtime35.jsx)(Component, { ...fixedProps, ...props, ref }));
    Extended.extend = Component.extend;
    Extended.displayName = `WithProps(${Component.displayName})`;
    return Extended;
  };
...
var DirectionContext = (0, import_react110.createContext)({
  dir: "ltr",
  toggleDirection: () => {
  },
  setDirection: () => {
...
function useDirection() {
  return (0, import_react110.useContext)(DirectionContext);
}
function DirectionProvider({
  ...
  const [dir, setDir] = (0, import_react110.useState)(initialDirection);
...
function useCollapse({
  ...
  const el = (0, import_react111.useRef)(null);
  const collapsedHeight = 0;
  const collapsedStyles = {
    height: 0,
    overflow: "hidden"
  };
  const [styles, setStylesRaw] = (0, import_react111.useState)(opened ? {} : collapsedStyles);
  ...
  function getCollapseProps({ style = {}, refKey = "ref", ...rest } = {}) {
    ...
    if (import_react111.default.version.startsWith("18")) {
      if (!opened) {
        props.inert = "";
      }
    } else {
...
var index = typeof document !== "undefined" ? import_react113.useLayoutEffect : import_react113.useEffect;
...
function useLatestRef(value) {
  const ref = (0, import_react113.useRef)(value);
  index(() => {
    ref.current = value;
  });
  return ref;
...
var InputLabel = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime92.jsxs)(
    Box,
    {
      ...
      children: [
        children,
        required && (0, import_jsx_runtime92.jsx)("span", { ...getStyles("required"), "aria-hidden": true, children: " *" })
      ]
    }
  );
});
...
var InputWrapper = factory((_props, ref) => {
  ...
  const _input = (0, import_jsx_runtime94.jsx)(import_react176.Fragment, { children: inputContainer(children) }, "input");
...
var Input = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime95.jsx)(InputContext, { value: { size: size2 || "sm" }, children: (0, import_jsx_runtime95.jsxs)(
    Box,
    {
      ...getStyles("wrapper"),
      ...styleProps,
...
var FloatingIndicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime100.jsx)(Box, { ref: mergedRef, mod: [{ initialized, hidden: hidden2 }, mod], ...getStyles("root"), ...others });
});
...
function Accordion(_props) {
  ...
  return (0, import_jsx_runtime107.jsx)(
    AccordionProvider,
    {
      ...
      children: (0, import_jsx_runtime107.jsx)(Box, { ...getStyles("root"), id: uid, ...others, variant, "data-accordion": true, children })
    }
  );
}
...
var Affix = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime108.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime108.jsx)(Box, { ref, ...getStyles("root"), ...others }) });
});
...
var Alert = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime109.jsx)(
    Box,
    {
      ...
      children: (0, import_jsx_runtime109.jsxs)("div", { ...getStyles("wrapper"), children: [
        icon && (0, import_jsx_runtime109.jsx)("div", { ...getStyles("icon"), children: icon }),
        (0, import_jsx_runtime109.jsxs)("div", { ...getStyles("body"), children: [
          title && (0, import_jsx_runtime109.jsx)("div", { ...getStyles("title"), "data-with-close-button": withCloseButton || void 0, children: (0, import_jsx_runtime109.jsx)("span", { id: titleId, ...getStyles("label"), children: title }) }),
          children && (0, import_jsx_runtime109.jsx)("div", { id: bodyId, ...getStyles("message"), "data-variant": variant, children })
        ] }),
...
var AngleSlider = factory((_props, ref) => {
  ...
  const rootRef = (0, import_react194.useRef)(null);
  ...
  const marksItems = marks == null ? void 0 : marks.map((mark, index4) => (0, import_react194.createElement)(
    "div",
    {
  ...
  return (0, import_jsx_runtime112.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        marksItems && marksItems.length > 0 && (0, import_jsx_runtime112.jsx)("div", { ...getStyles("marks"), children: marksItems }),
        withLabel && (0, import_jsx_runtime112.jsx)("div", { ...getStyles("label"), children: typeof formatLabel === "function" ? formatLabel(_value) : _value }),
...
var AppShell = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime128.jsxs)(AppShellProvider, { value: { getStyles, withBorder, zIndex, disabled, offsetScrollbars }, children: [
...
var AspectRatio = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime129.jsx)(Box, { ref, ...getStyles("root"), ...others });
});
...
var ComboboxClearButton = (0, import_react215.forwardRef)(
  ({ size: size2, onMouseDown, onClick, onClear, ...others }, ref) => (0, import_jsx_runtime132.jsx)(
    Input.ClearButton,
    {
      ref,
      tabIndex: -1,
      ...
      Box,
      {
        ...
        children: (0, import_jsx_runtime146.jsxs)(
          Box,
          {
            ...
            children: [
              children,
              (0, import_jsx_runtime146.jsxs)("div", { ...getStyles("labelWrapper"), "data-disabled": disabled || void 0, children: [
                ...
                description && (0, import_jsx_runtime146.jsx)(Input.Description, { size: size2, __inheritStyles: false, ...getStyles("description"), children: description }),
                error2 && typeof error2 !== "boolean" && (0, import_jsx_runtime146.jsx)(Input.Error, { size: size2, __inheritStyles: false, ...getStyles("error"), children: error2 })
              ] })
            ]
          }
        )
...
var CheckboxGroup = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime150.jsx)(CheckboxGroupProvider, { value: { value: _value, onChange: handleChange, size: size2 }, children: (0, import_jsx_runtime150.jsx)(
    Input.Wrapper,
    {
      size: size2,
      ref,
...
var CheckboxIndicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime152.jsx)(
    Box,
    {
      ...
      ...others,
      children: (0, import_jsx_runtime152.jsx)(Icon, { indeterminate, ...getStyles("icon") })
    }
  );
});
...
var Checkbox = factory((_props, forwardedRef) => {
  ...
  const fallbackRef = (0, import_react238.useRef)(null);
  ...
  return (0, import_jsx_runtime153.jsx)(
    InlineInput,
    {
      ...
      ...styleProps,
      ...wrapperProps,
      children: (0, import_jsx_runtime153.jsxs)(Box, { ...getStyles("inner"), mod: { "data-label-position": labelPosition }, children: [
        ...
        (0, import_jsx_runtime153.jsx)(Icon, { indeterminate, ...getStyles("icon") })
      ] })
    }
  );
});
...
function OptionsDropdown({
  ...
  return (0, import_jsx_runtime154.jsx)(Combobox.Dropdown, { hidden: hidden2 || hiddenWhenEmpty && isEmpty, "data-composed": true, children: (0, import_jsx_runtime154.jsxs)(Combobox.Options, { labelledBy: labelId, "aria-label": ariaLabel, children: [
...
var AvatarGroup = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime156.jsx)(AvatarGroupProvider, { value: true, children: (0, import_jsx_runtime156.jsx)(Box, { ref, ...getStyles("group"), ...others }) });
});
...
var Avatar = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime158.jsx)(
    Box,
    {
      ...
      ref,
      ...others,
      children: error2 || !src ? (0, import_jsx_runtime158.jsx)("span", { ...getStyles("placeholder"), title: alt, children: children || typeof name === "string" && getInitials(name) || (0, import_jsx_runtime158.jsx)(AvatarPlaceholderIcon, {}) }) : (0, import_jsx_runtime158.jsx)(
        "img",
        {
          ...imageProps,
          ...getStyles("image"),
...
var Badge = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime160.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        leftSection && (0, import_jsx_runtime160.jsx)("span", { ...getStyles("section"), "data-position": "left", children: leftSection }),
        (0, import_jsx_runtime160.jsx)("span", { ...getStyles("label"), children }),
        rightSection && (0, import_jsx_runtime160.jsx)("span", { ...getStyles("section"), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var Blockquote = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime161.jsxs)(Box, { component: "blockquote", ref, ...getStyles("root"), ...others, children: [
    icon && (0, import_jsx_runtime161.jsx)("span", { ...getStyles("icon"), children: icon }),
    children,
    cite && (0, import_jsx_runtime161.jsx)("cite", { ...getStyles("cite"), children: cite })
  ] });
});
...
var Breadcrumbs = factory((_props, ref) => {
  ...
  const items = import_react246.Children.toArray(children).reduce((acc, child, index4, array) => {
    var _a;
    const item = isElement2(child) ? (0, import_react246.cloneElement)(child, {
      ...getStyles("breadcrumb", { className: (_a = child.props) == null ? void 0 : _a.className }),
      key: index4
    }) : (0, import_react246.createElement)("div", { ...getStyles("breadcrumb"), key: index4 }, child);
    acc.push(item);
    if (index4 !== array.length - 1) {
      acc.push(
        (0, import_react246.createElement)(Box, { ...getStyles("separator"), key: `separator-${index4}` }, separator)
      );
    }
    return acc;
  }, []);
  return (0, import_jsx_runtime162.jsx)(Box, { ref, ...getStyles("root"), ...others, children: items });
});
...
var Burger = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime163.jsxs)(UnstyledButton, { ...getStyles("root"), ref, ...others, children: [
    (0, import_jsx_runtime163.jsx)(Box, { mod: ["reduce-motion", { opened }], ...getStyles("burger") }),
    children
  ] });
});
...
var ButtonGroupSection = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime165.jsx)(Box, { ...getStyles("groupSection"), ref, variant, ...others });
});
...
var Button = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime166.jsxs)(
    UnstyledButton,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime166.jsx)(Transition, { mounted: !!loading, transition: loaderTransition, duration: 150, children: (transitionStyles) => (0, import_jsx_runtime166.jsx)(Box, { component: "span", ...getStyles("loader", { style: transitionStyles }), "aria-hidden": true, children: (0, import_jsx_runtime166.jsx)(
          Loader,
          {
        ...
        (0, import_jsx_runtime166.jsxs)("span", { ...getStyles("inner"), children: [
          leftSection && (0, import_jsx_runtime166.jsx)(Box, { component: "span", ...getStyles("section"), mod: { position: "left" }, children: leftSection }),
          (0, import_jsx_runtime166.jsx)(Box, { component: "span", mod: { loading }, ...getStyles("label"), children }),
          rightSection && (0, import_jsx_runtime166.jsx)(Box, { component: "span", ...getStyles("section"), mod: { position: "right" }, children: rightSection })
        ] })
      ]
    }
  );
...
var Card = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime169.jsx)(CardProvider, { value: { getStyles }, children: (0, import_jsx_runtime169.jsx)(Paper, { ref, unstyled, ...getStyles("root"), ...others, children: content }) });
});
...
var Center = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime170.jsx)(Box, { ref, mod: [{ inline: inline2 }, mod], ...getStyles("root"), ...others });
});
      ...
      children: [
        ...
        (0, import_jsx_runtime173.jsxs)(
          "label",
          {
            ...
            children: [
              _checked && (0, import_jsx_runtime173.jsx)("span", { ...getStyles("iconWrapper"), children: icon || (0, import_jsx_runtime173.jsx)(CheckIcon, { ...getStyles("checkIcon") }) }),
...
var ColorSwatch = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime175.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime175.jsx)("span", { ...getStyles("alphaOverlay") }),
        withShadow && (0, import_jsx_runtime175.jsx)("span", { ...getStyles("shadowOverlay") }),
        (0, import_jsx_runtime175.jsx)("span", { ...getStyles("colorOverlay", { style: { backgroundColor: color } }) }),
        (0, import_jsx_runtime175.jsx)("span", { ...getStyles("childrenOverlay"), children })
      ]
    }
  );
});
...
var Thumb2 = (0, import_react261.forwardRef)(({ position, ...others }, ref) => (0, import_jsx_runtime177.jsx)(
  Box,
  {
    ref,
    __vars: {
...
var ColorSlider = factory((_props, ref) => {
  ...
  const layers = overlays.map((overlay, index4) => (0, import_react262.createElement)("div", { ...getStyles("sliderOverlay"), style: overlay, key: index4 }));
  ...
  return (0, import_jsx_runtime181.jsxs)(
    Box,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime181.jsx)(Thumb2, { position, ...getStyles("thumb", { style: { backgroundColor: color } }) })
      ]
    }
  );
}
...
var Swatches = (0, import_react266.forwardRef)(
  ({
    ...
    const colors = data.map((color, index4) => (0, import_react266.createElement)(
      ColorSwatch,
      {
...
var ColorPicker = factory((_props, ref) => {
  ...
  const formatRef = (0, import_react267.useRef)(format2 || "hex");
  ...
  return (0, import_jsx_runtime183.jsx)(ColorPickerProvider, { value: { getStyles, unstyled }, children: (0, import_jsx_runtime183.jsxs)(
    Box,
    {
      ref,
      ...getStyles("wrapper"),
      ...
      children: [
        withPicker && (0, import_jsx_runtime183.jsxs)(import_jsx_runtime183.Fragment, { children: [
          ...
          (0, import_jsx_runtime183.jsxs)("div", { ...getStyles("body"), children: [
            (0, import_jsx_runtime183.jsxs)("div", { ...getStyles("sliders"), children: [
              (0, import_jsx_runtime183.jsx)(
                HueSlider,
                {
                  value: parsed.h,
...
var ColorInput = factory((_props, ref) => {
  ...
  const eyeDropper = (0, import_jsx_runtime185.jsx)(
    ActionIcon,
    {
      ...
      children: eyeDropperIcon || (0, import_jsx_runtime185.jsx)(EyeDropperIcon, { ...getStyles("eyeDropperIcon") })
    }
  );
...
var Container = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime186.jsx)(Box, { ref, mod: [{ fluid }, mod], ...getStyles("root"), ...others });
});
    ...
    Affix,
    {
      ...
      children: (0, import_jsx_runtime188.jsx)(Transition, { keepMounted, mounted: opened, ...transitionProps, children: (transitionStyles) => (0, import_jsx_runtime188.jsxs)(
        Paper,
        {
          ...
          ...others,
          children: [
            withCloseButton && (0, import_jsx_runtime188.jsx)(CloseButton, { onClick: onClose, unstyled, ...getStyles("closeButton") }),
            children
          ]
        }
      ) })
...
var Divider = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime189.jsx)(
    Box,
    {
      ...
      ...others,
      role: "separator",
      children: label && (0, import_jsx_runtime189.jsx)(Box, { component: "span", mod: { position: labelPosition }, ...getStyles("label"), children: label })
    }
  );
});
...
var DrawerRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime196.jsx)(DrawerProvider, { value: { scrollAreaComponent, getStyles, radius }, children: (0, import_jsx_runtime196.jsx)(
    ModalBase,
    {
      ref,
      ...getStyles("root"),
...
var Fieldset = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime200.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        legend && (0, import_jsx_runtime200.jsx)("legend", { ...getStyles("legend", { variant }), children: legend }),
        children
      ]
    }
  );
...
var Grid = factory((_props, ref) => {
  ...
  if (type === "container" && breakpoints) {
    return (0, import_jsx_runtime207.jsxs)(GridProvider, { value: { getStyles, grow, columns, breakpoints, type }, children: [
      (0, import_jsx_runtime207.jsx)(GridVariables, { selector: `.${responsiveClassName}`, ...props }),
      (0, import_jsx_runtime207.jsx)("div", { ...getStyles("container"), children: (0, import_jsx_runtime207.jsx)(Box, { ref, ...getStyles("root", { className: responsiveClassName }), ...others, children: (0, import_jsx_runtime207.jsx)("div", { ...getStyles("inner"), children }) }) })
    ] });
  }
  return (0, import_jsx_runtime207.jsxs)(GridProvider, { value: { getStyles, grow, columns, breakpoints, type }, children: [
    (0, import_jsx_runtime207.jsx)(GridVariables, { selector: `.${responsiveClassName}`, ...props }),
    (0, import_jsx_runtime207.jsx)(Box, { ref, ...getStyles("root", { className: responsiveClassName }), ...others, children: (0, import_jsx_runtime207.jsx)("div", { ...getStyles("inner"), children }) })
  ] });
});
...
var Mark = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime209.jsx)(Box, { component: "mark", ref, variant, ...getStyles("root"), ...others });
});
...
var HoverCardTarget = (0, import_react298.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime213.jsx)(Popover.Target, { refProp, ref, ...others, children: (0, import_react298.cloneElement)(
    children,
...
var Indicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime217.jsxs)(Box, { ref, ...getStyles("root"), mod: [{ inline: inline2 }, mod], ...others, children: [
...
var index2 = import_react303.useLayoutEffect;

// node_modules/use-latest/dist/use-latest.esm.js
var useLatest = function useLatest2(value) {
  var ref = import_react304.default.useRef(value);
  index2(function() {
    ref.current = value;
  });
  return ref;
...
var useComposedRef = function useComposedRef2(libRef, userRef) {
  var prevUserRef = import_react305.default.useRef();
  return import_react305.default.useCallback(function(instance) {
...
var Kbd = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime220.jsx)(Box, { component: "kbd", ref, ...getStyles("root"), ...others });
});
...
var List = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime223.jsx)(ListProvider, { value: { center, icon, getStyles }, children: (0, import_jsx_runtime223.jsx)(
    Box,
    {
...
var LoadingOverlay = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime224.jsx)(Transition, { transition: "fade", ...transitionProps, mounted: !!visible2, children: (transitionStyles) => (0, import_jsx_runtime224.jsxs)(Box, { ...getStyles("root", { style: transitionStyles }), ref, ...others, children: [
    (0, import_jsx_runtime224.jsx)(Loader, { ...getStyles("loader"), unstyled, ...loaderProps }),
...
var MenuTarget = (0, import_react323.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime235.jsx)(Popover.Target, { refProp, popupType: "menu", ref, ...others, children: (0, import_react323.cloneElement)(children, {
    onClick,
    onMouseEnter,
    onMouseLeave,
...
var ModalRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime243.jsx)(ModalProvider, { value: { yOffset, scrollAreaComponent, getStyles, fullScreen }, children: (0, import_jsx_runtime243.jsx)(
    ModalBase,
    {
      ref,
      ...getStyles("root"),
...
function useModalsStack(modals) {
  ...
  const [state, setState] = (0, import_react335.useState)(initialState);
  const open = (0, import_react335.useCallback)((modal) => {
    setState((current) => ({ ...current, [modal]: true }));
  }, []);
  const close = (0, import_react335.useCallback)(
    (modal) => setState((current) => ({ ...current, [modal]: false })),
    []
  );
  const toggle = (0, import_react335.useCallback)(
    (modal) => setState((current) => ({ ...current, [modal]: !current[modal] })),
    []
  );
  const closeAll = (0, import_react335.useCallback)(() => setState(initialState), []);
  const register = (0, import_react335.useCallback)(
    (modal) => ({
      opened: state[modal],
      onClose: () => close(modal),
      stackId: modal
...
var PillGroup = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime249.jsx)(PillGroupProvider, { value: { size: _size, disabled }, children: (0, import_jsx_runtime249.jsx)(Box, { ref, size: _size, ...getStyles("group"), ...others }) });
});
...
var Pill = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime250.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime250.jsx)("span", { ...getStyles("label"), children }),
...
var PillsInput = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime252.jsx)(PillsInputProvider, { value: { fieldRef, size: size2, disabled, hasError: !!error2, variant }, children: (0, import_jsx_runtime252.jsx)(
    InputBase,
    {
      size: size2,
      error: error2,
        ...
        children: [
          (0, import_jsx_runtime254.jsx)(Combobox.DropdownTarget, { children: (0, import_jsx_runtime254.jsx)(
            PillsInput,
            {
              ...
              required,
              mod,
              children: (0, import_jsx_runtime254.jsxs)(Pill.Group, { disabled, unstyled, ...getStyles("pillsList"), children: [
                values2,
...
var NativeSelect = factory((props, ref) => {
  ...
  const options = getParsedComboboxData(data).map((item, index4) => (0, import_jsx_runtime256.jsx)(NativeSelectOption, { data: item }, index4));
  return (0, import_jsx_runtime256.jsx)(
    InputBase,
    {
      ...
      error: error2,
      unstyled,
      rightSection: rightSection || (0, import_jsx_runtime256.jsx)(ComboboxChevron, { size: size2, error: error2, unstyled }),
  ...
  return (0, import_jsx_runtime257.jsxs)(import_jsx_runtime257.Fragment, { children: [
    (0, import_jsx_runtime257.jsxs)(
      UnstyledButton,
      {
        ...
        ...others,
        children: [
          leftSection && (0, import_jsx_runtime257.jsx)(Box, { component: "span", ...getStyles("section"), mod: { position: "left" }, children: leftSection }),
          (0, import_jsx_runtime257.jsxs)(Box, { ...getStyles("body"), mod: { "no-wrap": noWrap }, children: [
            (0, import_jsx_runtime257.jsx)(Box, { component: "span", ...getStyles("label"), children: label }),
            (0, import_jsx_runtime257.jsx)(Box, { component: "span", mod: { active }, ...getStyles("description"), children: description })
          ] }),
          (withChildren || rightSection !== void 0) && (0, import_jsx_runtime257.jsx)(
            Box,
            {
              ...
              children: withChildren ? rightSection !== void 0 ? rightSection : (0, import_jsx_runtime257.jsx)(AccordionChevron, { ...getStyles("chevron") }) : rightSection
            }
          )
        ]
      }
    ),
    withChildren && (0, import_jsx_runtime257.jsx)(Collapse, { in: _opened, ...getStyles("collapse"), children: (0, import_jsx_runtime257.jsx)("div", { ...getStyles("children"), children }) })
  ] });
});
...
var Notification = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime258.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        icon && !loading && (0, import_jsx_runtime258.jsx)("div", { ...getStyles("icon"), children: icon }),
        loading && (0, import_jsx_runtime258.jsx)(Loader, { size: 28, color, ...loaderProps, ...getStyles("loader") }),
        (0, import_jsx_runtime258.jsxs)("div", { ...getStyles("body"), children: [
          title && (0, import_jsx_runtime258.jsx)("div", { ...getStyles("title"), children: title }),
          (0, import_jsx_runtime258.jsx)(Box, { ...getStyles("description"), mod: { "data-with-title": !!title }, children })
        ] }),
...
function NumberFormatBase(props) {
  ...
  var useIsomorphicLayoutEffect = typeof window !== "undefined" ? import_react347.useLayoutEffect : import_react347.useEffect;
...
var NumberInput = factory((_props, ref) => {
  ...
  const controls = (0, import_jsx_runtime261.jsxs)("div", { ...getStyles("controls"), children: [
...
function PaginationItems({ dotsIcon }) {
  ...
  const items = ctx.range.map((page, index4) => {
    var _a, _b, _c;
    if (page === "dots") {
      return (0, import_jsx_runtime267.jsx)(PaginationDots, { icon: dotsIcon }, index4);
    }
...
var PaginationRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime268.jsx)(
    PaginationProvider,
    {
      ...
      children: (0, import_jsx_runtime268.jsx)(Box, { ref, ...getStyles("root"), ...others })
    }
  );
});
  ...
  return (0, import_jsx_runtime272.jsxs)(import_jsx_runtime272.Fragment, { children: [
    (0, import_jsx_runtime272.jsx)(
      Group,
      {
        ...
        __size: size2,
        dir: "ltr",
        children: _value.map((char, index4) => (0, import_react357.createElement)(
          Input,
          {
            component: "input",
            ...getStyles("pinInput", {
...
var ProgressRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime275.jsx)(ProgressProvider, { value: { getStyles, autoContrast }, children: (0, import_jsx_runtime275.jsx)(Box, { ref, ...getStyles("root"), ...others }) });
});
...
var RadioGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size2, wrapperProps, children, name, readOnly, ...others } = useProps("RadioGroup", defaultProps152, props);
  ...
  return (0, import_jsx_runtime281.jsx)(RadioGroupProvider, { value: { value: _value, onChange: handleChange, size: size2, name: _name }, children: (0, import_jsx_runtime281.jsx)(
    Input.Wrapper,
    {
      size: size2,
      ref,
...
var RadioIndicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime283.jsx)(
    Box,
    {
      ...
      mod: [{ checked: _checked, disabled }, mod],
      ...others,
      children: (0, import_jsx_runtime283.jsx)(Icon, { ...getStyles("icon") })
    }
  );
});
...
var Radio = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime284.jsx)(
    InlineInput,
    {
      ...
      ...styleProps,
      ...wrapperProps,
      children: (0, import_jsx_runtime284.jsxs)(Box, { ...getStyles("inner"), mod: { "label-position": labelPosition }, children: [
        ...
        (0, import_jsx_runtime284.jsx)(Icon, { ...getStyles("icon"), "aria-hidden": true })
      ] })
    }
  );
});
...
var Rating = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime289.jsx)(RatingProvider, { value: { getStyles }, children: (0, import_jsx_runtime289.jsx)(
    Box,
    {
...
var RingProgress = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime294.jsxs)(Box, { ...getStyles("root"), size: size2, ref, ...others, children: [
    (0, import_jsx_runtime294.jsx)("svg", { ...getStyles("svg"), children: curves }),
    label && (0, import_jsx_runtime294.jsx)("div", { ...getStyles("label"), children: label })
  ] });
});
...
var SegmentedControl = factory((_props, ref) => {
  ...
  const controls = _data.map((item) => (0, import_react384.createElement)(
    ...
    (0, import_react384.createElement)(
      ...
      (0, import_jsx_runtime295.jsx)("span", { ...getStyles("innerLabel"), children: item.label })
    )
  ));
...
var SemiCircleProgress = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime297.jsxs)(Box, { ref, size: size2, ...getStyles("root"), ...others, children: [
    label && (0, import_jsx_runtime297.jsx)("p", { ...getStyles("label"), "data-position": labelPosition, "data-orientation": orientation, children: label }),
    (0, import_jsx_runtime297.jsxs)("svg", { width: size2, height: size2 / 2, ...getStyles("svg"), children: [
...
var SimpleGrid = factory((_props, ref) => {
  ...
  if (type === "container") {
    return (0, import_jsx_runtime299.jsxs)(import_jsx_runtime299.Fragment, { children: [
      ...
      (0, import_jsx_runtime299.jsx)("div", { ...getStyles("container"), children: (0, import_jsx_runtime299.jsx)(Box, { ref, ...getStyles("root", { className: responsiveClassName }), ...others }) })
    ] });
  }
  return (0, import_jsx_runtime299.jsxs)(import_jsx_runtime299.Fragment, { children: [
    (0, import_jsx_runtime299.jsx)(SimpleGridMediaVariables, { ...props, selector: `.${responsiveClassName}` }),
    (0, import_jsx_runtime299.jsx)(Box, { ref, ...getStyles("root", { className: responsiveClassName }), ...others })
  ] });
});
...
var Skeleton = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime300.jsx)(Box, { ref, ...getStyles("root"), mod: [{ visible: visible2, animate }, mod], ...others });
});
        ...
        children: [
          ...
          (0, import_jsx_runtime303.jsx)(
            Transition,
            {
              ...
              duration: 0,
              ...labelTransitionProps,
              children: (transitionStyles) => (0, import_jsx_runtime303.jsx)("div", { ...getStyles("label", { style: transitionStyles }), children: label })
            }
          )
        ]
      }
...
function Marks({ marks, min: min2, max: max2, disabled, value, offset: offset2, inverted }) {
  ...
  const items = marks.map((mark, index4) => (0, import_react393.createElement)(
    ...
    mark.label && (0, import_jsx_runtime304.jsx)("div", { ...getStyles("markLabel"), children: mark.label })
  ));
...
function Track({
  ...
  const { getStyles } = useSliderContext();
  return (0, import_jsx_runtime305.jsx)(Box, { ...getStyles("trackContainer"), mod: { disabled }, ...containerProps, children: (0, import_jsx_runtime305.jsxs)(Box, { ...getStyles("track"), mod: { inverted, disabled }, children: [
...
var Slider = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime306.jsx)(SliderProvider, { value: { getStyles }, children: (0, import_jsx_runtime306.jsxs)(
    SliderRoot,
    {
      ...others,
...
var RangeSlider = factory((_props, ref) => {
  ...
  const containerRef = (0, import_react396.useRef)(null);
  const { dir } = useDirection();
  ...
  return (0, import_jsx_runtime307.jsx)(SliderProvider, { value: { getStyles }, children: (0, import_jsx_runtime307.jsxs)(
    SliderRoot,
    {
      ...others,
      size: size2,
...
var Stack = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime310.jsx)(Box, { ref, ...getStyles("root"), variant, ...others });
});
...
var getStepFragment = (Fragment27, step) => {
  if (typeof Fragment27 === "function") {
    return (0, import_jsx_runtime312.jsx)(Fragment27, { step: step || 0 });
  }
  return Fragment27;
};
var defaultProps170 = {
...
var Stepper = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime313.jsx)(StepperProvider, { value: { getStyles, orientation, iconPosition }, children: (0, import_jsx_runtime313.jsxs)(Box, { ...getStyles("root"), ref, size: size2, ...others, children: [
    ...
    content && (0, import_jsx_runtime313.jsx)("div", { ...getStyles("content"), children: content })
  ] }) });
});
...
var SwitchGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size2, wrapperProps, children, readOnly, ...others } = useProps("SwitchGroup", defaultProps172, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [],
  ...
  return (0, import_jsx_runtime314.jsx)(SwitchGroupProvider, { value: { value: _value, onChange: handleChange, size: size2 }, children: (0, import_jsx_runtime314.jsx)(
    Input.Wrapper,
    {
      size: size2,
      ref,
        ...
        (0, import_jsx_runtime315.jsxs)(
          Box,
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime315.jsx)("span", { ...getStyles("trackLabel"), children: _checked ? onLabel : offLabel })
            ]
          }
        )
      ]
...
function TableDataRenderer({ data }) {
  return (0, import_jsx_runtime318.jsxs)(import_jsx_runtime318.Fragment, { children: [
    ...
    data.head && (0, import_jsx_runtime318.jsx)(TableThead, { children: (0, import_jsx_runtime318.jsx)(TableTr, { children: data.head.map((item, index4) => (0, import_jsx_runtime318.jsx)(TableTh, { children: item }, index4)) }) }),
    data.body && (0, import_jsx_runtime318.jsx)(TableTbody, { children: data.body.map((row, rowIndex) => (0, import_jsx_runtime318.jsx)(TableTr, { children: row.map((item, index4) => (0, import_jsx_runtime318.jsx)(TableTd, { children: item }, index4)) }, rowIndex)) }),
    data.foot && (0, import_jsx_runtime318.jsx)(TableTfoot, { children: (0, import_jsx_runtime318.jsx)(TableTr, { children: data.foot.map((item, index4) => (0, import_jsx_runtime318.jsx)(TableTh, { children: item }, index4)) }) })
  ] });
}
...
var TableScrollContainer = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime319.jsx)(
    Box,
    {
      ...
      ...others,
      children: (0, import_jsx_runtime319.jsx)("div", { ...getStyles("scrollContainerInner"), children })
    }
  );
});
...
var TableOfContents = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime321.jsx)(Box, { ref, variant, ...getStyles("root"), ...others, children: controls });
});
...
var TagsInput = factory((_props, ref) => {
  ...
  const values2 = _value.map((item, index4) => (0, import_jsx_runtime328.jsx)(
    Pill,
    {
        ...
        children: [
          (0, import_jsx_runtime328.jsx)(Combobox.DropdownTarget, { children: (0, import_jsx_runtime328.jsx)(
            PillsInput,
            {
              ...
              id: _id,
              mod,
              children: (0, import_jsx_runtime328.jsxs)(Pill.Group, { disabled, unstyled, ...getStyles("pillsList"), children: [
                values2,
...
var ThemeIcon = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime330.jsx)(Box, { ref, ...getStyles("root"), ...others });
});
...
var Timeline = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime333.jsx)(TimelineProvider, { value: { getStyles }, children: (0, import_jsx_runtime333.jsx)(Box, { ...getStyles("root"), mod: [{ align }, mod], ref, ...others, children: items }) });
});
  ...
  return (0, import_jsx_runtime336.jsxs)(
    "li",
    {
      ...
      children: [
        ...
        controller.expandedState[node.value] && nested.length > 0 && (0, import_jsx_runtime336.jsx)(Box, { component: "ul", role: "group", ...getStyles("subtree"), "data-level": level, children: nested })
      ]
    }
  );
}
...
var Tree = factory((_props, ref) => {
  ...
  const nodes = data.map((node, index4) => (0, import_jsx_runtime339.jsx)(
    TreeNode,
    {
      node,
      getStyles,
...
var TypographyStylesProvider = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime340.jsx)(Box, { ref, ...getStyles("root"), ...others });
});
