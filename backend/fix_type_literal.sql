-- Correction du problème de type avec valeurs littérales explicites
-- ================================================================

-- Recréer la fonction en utilisant des valeurs littérales explicites
...
SELECT 
    'Test fonction avec valeurs litterales' as test_type,
    COUNT(*) as resultats
