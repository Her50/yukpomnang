-- Correction de la fonction search_images_by_metadata avec GROUP BY
-- Base de données: yukpo_db

-- Supprimer l'ancienne fonction
DROP FUNCTION IF EXISTS search_images_by_metadata(TEXT, INTEGER);

-- Créer la fonction corrigée avec GROUP BY
...
SELECT 'Fonction search_images_by_metadata corrigée avec GROUP BY' as status;
