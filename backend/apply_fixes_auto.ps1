# Script automatique pour appliquer les corrections
...
if (-not $env:PGPASSWORD) {
    Write-Host "ERREUR: Variable PGPASSWORD non definie!" -ForegroundColor Red
    Write-Host "Definissez-la avec: $env:PGPASSWORD = 'votre_mot_de_passe'" -ForegroundColor Yellow
    exit 1
}
