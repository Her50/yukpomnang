-- Correction finale du problème de type
-- ====================================

-- Recréer la fonction avec une approche différente pour éviter le problème de type
...
SELECT 
    'Test fonction corrigee finale' as test_type,
    COUNT(*) as resultats
