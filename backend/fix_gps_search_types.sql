-- Correction des types de données pour les fonctions GPS
-- Résout les erreurs de type character varying vs text

-- 1. Fonction GPS simplifiée et rapide (types corrigés)
...
-- 2. Fonction de recherche rapide par texte + GPS (types corrigés)
...
-- 3. Test des nouvelles fonctions corrigées
SELECT 'Test fast_gps_search corrigee' as test_name;
SELECT * FROM fast_gps_search('4.0511,9.7679', 50, 5);

SELECT 'Test fast_text_gps_search corrigee' as test_name;
