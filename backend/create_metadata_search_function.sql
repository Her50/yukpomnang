-- Création de la fonction search_images_by_metadata
-- Base de données: yukpo_db

-- Créer la fonction de recherche par métadonnées
...
BEGIN
    ...
    SELECT
        ...
        (
            ...
            CASE
                WHEN m.image_metadata->>'file_size' IS NOT NULL AND query_metadata->>'file_size' IS NOT NULL THEN
                    CASE
...
SELECT 'Fonction search_images_by_metadata créée' as status;
