-- TEST GPS : Point simple + Zone polygonale
...
-- =====================================================
-- ÉTAPE 4: VÉRIFICATION DES DONNÉES SOURCES
-- =====================================================

SELECT '--- ÉTAPE 4: Vérification des données sources ---' as etape;

-- Test 4.1: Vérifier les services disponibles avec GPS
SELECT '4.1. Services disponibles avec GPS' as test;
SELECT 
    s.id,
...
-- Test 4.2: Vérifier les utilisateurs avec GPS
SELECT '4.2. Utilisateurs avec GPS' as test;
SELECT 
    id,
    email,
    gps,
