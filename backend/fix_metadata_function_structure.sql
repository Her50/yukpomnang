-- Correction de la structure de retour de la fonction search_images_by_metadata
-- Base de données: yukpo_db

-- Supprimer l'ancienne fonction
DROP FUNCTION IF EXISTS search_images_by_metadata(TEXT, INTEGER);

-- Créer la fonction avec la structure de retour correcte
...
SELECT 'Fonction search_images_by_metadata corrigée avec structure de retour' as status;
