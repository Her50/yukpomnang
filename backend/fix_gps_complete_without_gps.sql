-- CORRECTION COMPLÈTE GPS AVEC SUPPORT SANS ZONE GPS
-- ===================================================

-- Recréer la fonction pour gérer TOUS les cas (avec et sans GPS)
...
SELECT
    'Test recherche AVEC zone GPS' as test_type,
    COUNT(*) as resultats
...
SELECT
    'Test recherche SANS zone GPS' as test_type,
    COUNT(*) as resultats
FROM search_services_gps_final(
    'restaurant',
